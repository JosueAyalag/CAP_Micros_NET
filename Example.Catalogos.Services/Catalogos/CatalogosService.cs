...
namespace Example.Catalogos.Services.Catalogos
{
    ...
    public class CatalogosService : ICatalogosService
    {
        ...
        /// <inheritdoc/>
        public async Task<bool> userUpdate(CatalogosDto model) {
            return await this.modelDao.userUpdate(this.mapper.Map<CatalogosModel>(model));
        }

        /// <inheritdoc/>
        public async Task<bool> userDelete(int id) 
        {
            return await this.modelDao.userDelete(id);
        }
